...
var updatedplayers = {
  Leaderboard: [
    { username: "zekes", score: "5000" },
    { username: "zekes2", score: "400" },
    { username: "zekes3", score: "300" },
    { username: "zekes4", score: "200" },
    { username: "zekes5", score: "100" }
  ]
};
//
//updateDatabase();
...
height = window.outerHeight; //full window height
width = window.outerWidth; // full window width
...
$.getJSON("https://api.jsonbin.io/b/5bc742b4adf9f5652a600a5a/latest", function(
  data
) {
...
function readDatabase() {
  ...
  req.open(
    "GET",
    "http://api.jsonbin.io/b/5bc742b4adf9f5652a600a5a/latest",
    true
  );
