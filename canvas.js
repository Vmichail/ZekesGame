...
canvas.height = document.documentElement.clientHeight - document.documentElement.clientHeight/6;
canvas.width = document.documentElement.clientWidth - document.documentElement.clientWidth/6;
...
$(window).keypress(function(e) {
    ...
    if ( pressedKey === " " ) {
        StartStopScreen(e);
    }else if (pressedKey == "ArrowUp" || pressedKey == "ArrowDown" || pressedKey == "w" || pressedKey == "s")
    {
        move(e);
    }
});
...
//Move function player 
  function  move(){
    ...
    if (pressedKey == "w" && (pSH - dmovement > 0)){
        movement = -30;
        pSH += movement;
        pEH = pSH + bH;
